...
const MyEducation = () => {
    ...
    return (
      <div className="py-10 bg-emerald-500/5 my-15 rounded-lg">
        <h2 data-aos="flip-left" className="text-3xl font-bold text-center mb-8 text-emerald-600">
          My Education
        </h2>
        <p data-aos="zoom-in" className="text-center text-gray-600 md:max-w-2xl mx-auto mb-8">
          My educational journey has built a strong foundation for both technical knowledge and
          creative thinking, enabling me to grow as a modern web developer.
        </p>
        ...
        <div className="max-w-7xl mx-auto px-4 grid gap-6 md:grid-cols-2">
          {educationData.map((edu, index) => (
            ...
            >
              <h3 className="text-xl font-semibold text-emerald-600 mb-1 text-center">
                {edu.degree}
              </h3>
